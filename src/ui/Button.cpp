...
void Button::setFontColor_up (uint8_t red, uint8_t green, uint8_t blue) {
  this->FontColor_up.r = red;
  this->FontColor_up.g = green;
  this->FontColor_up.b = blue;
}

void Button::setFontColor_down (uint8_t red, uint8_t green, uint8_t blue) {
...
void Button::setcolor(uint32_t SDL_color) {
  color = SDL_color;
}
