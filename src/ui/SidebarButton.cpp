 ...
 */
SidebarButton::SidebarButton(int x, int y, const std::string& picname, Uint8 func,
                             const std::string& theatre, Uint8 pal) :
 ...
 * @param fname fname
 */
void SidebarButton::ChangeImage(const std::string& fname)
{
  ChangeImage(fname, 0, 1);
}

void SidebarButton::ChangeImage(const std::string& fname, Uint8 number)
{
  ChangeImage(fname, number, 1);
}

void SidebarButton::ChangeImage(const std::string& fname, Uint8 number, Uint8 side)
{
  // Error checking
  if (side != 1 && side != 2)
  {
